...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://cleaningstack.com/zenmaid-review" },
};
...
export default function Page() {
  ...
  return (
    <ReviewPageTemplate
      tool={tool}
      intro="ZenMaid is the only major software platform built exclusively for maid and house cleaning businesses. That focus shows in every feature — from the recurring schedule templates designed for weekly and fortnightly clients, to the automated thank-you emails that go out after every clean. If you run a residential cleaning service, this is the software that was built for you. And with a genuine free plan for up to 3 active clients, there's zero financial risk in trying it."
      detailedReview={[
      ...
      faqs={[
        {
          ...
          answer: "Yes — ZenMaid's free plan is genuinely free with no time limit and no credit card required. You can manage up to 3 active clients with recurring schedules, automated emails, and online booking. It's not a trial — it's a permanent free tier designed for maid services just getting started.",
        },
        {
          question: "Can ZenMaid handle a team of 10 cleaners?",
          answer: "Yes — ZenMaid's Professional plan at $99/month handles team management, GPS clock-in, staff checklists, and multi-cleaner scheduling. The platform is used by maid services with up to 20 staff. Beyond 20 staff, Jobber or Housecall Pro typically offer more scalable team management.",
        },
        {
        ...
        },
        {
          ...
          answer: "The difference is dramatic. ZenMaid eliminates manual scheduling errors, sends automatic reminders to clients before every job, handles payment collection automatically, and sends follow-up emails when clients haven't rebooked. Most maid service owners report saving 3–5 hours per week within the first month. The free plan makes there's no reason not to try it.",
        },
        {
          question: "Can I import my existing client list into ZenMaid?",
          answer: "Yes — ZenMaid supports client import via CSV file. You can export your existing client data from a spreadsheet, clean it up, and import it directly into ZenMaid. The import process is documented in their help centre and takes under an hour for most businesses.",
        },
      ]}
      relatedPages={[
