...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://cleaningstack.com/housecall-pro-vs-zenmaid" },
};
...
export default function Page() {
  ...
  return (
    <HeadToHeadTemplate
      ...
      intro="Housecall Pro and ZenMaid both serve residential cleaning and maid service businesses, but they approach the problem from very different angles. ZenMaid was built exclusively for cleaning — it's simple, affordable, and has a free plan. Housecall Pro is a powerful all-in-one platform designed for growth-oriented service businesses, with strong marketing and client acquisition tools. This comparison helps you decide which is a better fit for where your business is right now."
      toolA={hcp}
      toolB={zenmaid}
      verdict="b"
      verdictReason="For pure maid services and residential cleaning businesses, ZenMaid is the better everyday tool — it's built specifically for your workflow, more affordable, and has a free plan for tiny operations. Housecall Pro is worth the premium if you're actively growing and want to automate your Google reviews and email marketing campaigns."
      toolAWins={[
        "Built-in automated review requests — sends to Google after every job",
      ...
      toolBWins={[
        "Free plan for up to 3 active clients — Housecall Pro has no free tier",
        "Purpose-built for maid services — no irrelevant features cluttering the interface",
      ...
      faqs={[
        ...
        },
        {
          ...
          answer: "No — Housecall Pro does not have a free plan. It offers a 14-day free trial on all paid plans. If you need a free tool to get started, ZenMaid offers a genuine free plan for up to 3 active clients, or Connecteam offers free scheduling and team management for up to 10 users.",
        },
        {
        ...
        },
        {
          ...
          answer: "For a small maid service (under 5 staff), Housecall Pro is likely overkill at $79–$189/month. You'd be paying for marketing features you may not use yet. ZenMaid at $49–$99/month gives you everything a small maid service needs. Revisit Housecall Pro when you're actively trying to grow through marketing and can attribute revenue from its campaigns.",
        },
        {
          question: "Can I import my clients from ZenMaid to Housecall Pro?",
          answer: "Yes — both platforms allow CSV export of client data, and Housecall Pro supports client imports. The process isn't fully automated but takes a few hours. If you're growing and considering switching, do it during a quiet period and give yourself a few weeks to get comfortable with the new platform before peak season.",
        },
      ]}
      relatedPages={[
        ...
        { title: "ZenMaid Review", href: "/zenmaid-review", description: "Full ZenMaid review — pricing, features, pros and cons." },
