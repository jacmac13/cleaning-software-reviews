...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://cleaningstack.com/servicem8-vs-jobber-australia" },
};
  ...
  return (
    <HeadToHeadTemplate
      ...
      toolAWins={[
        ...
        "Best-in-class Xero integration — seamless for Australian accounting workflows",
        "Job card and photo documentation system is the best in the category",
        "Lower entry cost — $29/month Starter plan (Jobber starts at $49/month)",
        "Designed with Australian service businesses in mind — supports GST invoicing natively",
      ]}
      toolBWins={[
      ...
      pricingAnalysis="ServiceM8's Starter plan at $29/month is the cheapest entry point of any platform in our reviews — but it's limited to 15 jobs per month, which is a real constraint for busy cleaning businesses. The Growing plan at $65/month (unlimited jobs, 1 included staff member) is the most practical plan for sole traders. For a 5-person cleaning team, ServiceM8 Premium at $149/month compares to Jobber Connect at $129/month. Both platforms are priced in USD — ServiceM8 was originally AUD-priced but moved to USD billing."
      faqs={[
        {
        ...
        },
        {
          ...
          answer: "Yes — ServiceM8 was designed for the Australian market and handles GST invoicing natively. Invoices automatically calculate and display GST, and the Xero integration keeps your BAS reporting clean. Jobber also supports GST through its QuickBooks or manual tax settings, but the setup is less seamless.",
        },
        {
          question: "What is the ServiceM8 Starter plan's 15-job limit?",
          answer: "ServiceM8's Starter plan ($29/month) allows up to 15 jobs per calendar month. If you're a sole trader doing 3–4 jobs per week, you'll hit this limit quickly. The Growing plan at $65/month removes the job limit and is the recommended plan for any cleaning business doing more than 15 jobs monthly.",
        },
        {
          question: "Does Jobber work well in Australia?",
          answer: "Yes — Jobber has a strong Australian user base and supports AUD pricing, Australian date formats, and integrations with both QuickBooks and Xero. The main limitation is that support is Canada-based, which means a time zone difference for urgent issues. ServiceM8 offers Australian business hours support.",
        },
        {
          question: "Can I try ServiceM8 for free in Australia?",
          answer: "Yes — ServiceM8 offers a 14-day free trial with access to all features. No credit card required. Jobber also offers a 14-day trial. We recommend trialling both if you're undecided — the hands-on experience of using each platform for your specific workflows is the best way to decide.",
        },
      ]}
      relatedPages={[
        ...
        { title: "Jobber Review", href: "/jobber-review-cleaning-business", description: "Full Jobber review — features and pricing." },
